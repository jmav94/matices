...
<section class="panel panel-default pos-rlt clearfix">
	...
	<div class="table-responsive">
		<table class="table table-striped b-t b-light" id="historial">
			<thead>
				<tr> 
					...
					<th width="90" class="text-right">Pagado</th>
					<th width="90" class="text-center">Estatus</th>
					<th width="90" class="text-center">Pedido</th>
					<th width="90" class="text-center">F. Entrega</th>
					<th width="238"> </th>
				</tr>
			</thead>
			<tbody>
				...
				while($q = mysql_fetch_object($query)){
					...
					<td>'.$q->fecha.'</td>
					<td>'.$q->hora.'</td>
					<td width= "150" >'.$q->nombre.'</td>
					<td width= "150">'.$q->ndest.'</td>
					<td width= "150">'.$q->dirdest.'</td>
					<td width= "150">'.$q->refdest.'</td>
